...
func _init(Card_Frame, Card_Art, Card_Name, Card_Type, Card_EffectType, Card_Attribute, Card_Description, Card_Short_Description, Card_Attack, Card_ATK_Bonus, Card_Cost, Card_Health, Card_Health_Bonus, Card_Special_Edition_Text, Card_Rarity, Card_Passcode, Card_Deck_Capacity, Card_Tokens, Card_Is_Set, Card_Effect_Active, Card_Fusion_Level, Card_Attack_As_Reinforcement, Card_Invincible, Card_Multi_Strike, Card_Target_Reinforcer, Card_Paralysis, Card_Owner):
	Frame = Card_Frame
	Art = Card_Art
	Name = Card_Name
	Type = Card_Type
