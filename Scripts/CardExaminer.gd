...
func LookAtCard():
	...
	if SelectedCard != null:
		if SelectedCard.get_node("Frame").texture_normal == load("res://Assets/Cards/Frame/Small_Frame_Normal.png"):
			...
			self.get_node("Text").set("theme_override_colors/font_outline_color", Color("676767"))
			self.get_node("Damage").set("theme_override_colors/font_outline_color", Color("676767"))
			self.get_node("Health").set("theme_override_colors/font_outline_color", Color("676767"))
			...
			self.get_node("Text").set("theme_override_colors/font_outline_color", Color("cdaf2f"))
			self.get_node("Damage").set("theme_override_colors/font_outline_color", Color("cdaf2f"))
			self.get_node("Health").set("theme_override_colors/font_outline_color", Color("cdaf2f"))
			...
			self.get_node("Text").set("theme_override_colors/font_outline_color", Color("7a51a0"))
			self.get_node("Damage").set("theme_override_colors/font_outline_color", Color("7a51a0"))
			self.get_node("Health").set("theme_override_colors/font_outline_color", Color("7a51a0"))
			...
			self.get_node("Text").set("theme_override_colors/font_outline_color", Color("ff0000"))
			self.get_node("Damage").set("theme_override_colors/font_outline_color", Color("ff0000"))
			self.get_node("Health").set("theme_override_colors/font_outline_color", Color("ff0000"))
			...
			self.get_node("Text").set("theme_override_colors/font_outline_color", Color("1f8742"))
			self.get_node("Damage").set("theme_override_colors/font_outline_color", Color("1f8742"))
			self.get_node("Health").set("theme_override_colors/font_outline_color", Color("1f8742"))
